g#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Kami Group
...
\033[1;93m▇▇▇▇▇ Facebook\033[1;93m KB Baloch ▇▇▇▇▇
\033[1;97m
                 ⊂ヽ
               　 ＼＼  Λ＿Λ
              　　 ＼(  ˘ω˘  )
                　　　 >　⌒ヽ
                 ...
                 　 /　/|
                  ...
                  　| |　　) /
                   ノ )    Lﾉ
                  (_／     　　　
\033[1;97m:•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;93mGhazaliKing\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"""
...
\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;92mPITAFI.KAMRAN\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"""
print  "\033[1;90m🔀 ⚌⚌⚌⚌⚌⚌⚍⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌ 🔀"
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
...
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[1;35m☠ Welcome to KAMI TERMUX  ☠ ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;92mGhazaliKing\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"

CorrectUsername = "KAMI"
CorrectPassword = "GHAZALI"
▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌
▌▌▌▌▌▄▄▄▄▄▄▄▄▄▌▌▌▌▌▌▌▌▌▌▌▌▌▄▄▄▄▄▄▄▄▄▌▌▌▌▌▌
▌▌▌▄▄▄▄▄▄▄▄▄▄▄▄▄▌▌▌▌▌▌▌▌▌▄▄▄▄▄▄▄▄▄▄▄▄▄▌▌▌▌
▌▌▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▌▌▌▌▌▌▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▌▌
...
def login():
	...
	try:
		...
		print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;92mKAMIGROUP\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
...
def menu():
	...
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;91mKAMI/GROUP\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
...
def pilih():
	...
	if unikers =="":
		...
		print " \033[1;91m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•Massage•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\n"
                ...
                jalan("\033[1;96mgit clone https://github.com/KAMIGROUP/KING")
                jalan('\033[1;96mcd KAMI')
                jalan('\033[1;96mpython2 KING')
                jalan('\033[1;96mUser: KAMI')
                jalan('\033[1;96mpass: GHAZALI')
                jalan('\033[1;92m👆Copy Command & send 2 groups👆')
                jalan('\033[1;91mYoutube Chenal Like Subscrib plzz')
		os.system('git pull origin master')
		raw_input('\n\x1b[1;91m[ \x1b[1;97mBack \x1b[1;91m]')
		menu()
        elif unikers =="10":#80FF00
		os.system('reset')
		print logo
		toket=open('login.txt','r').read()
...
def pilih_test():
	...
	for o in titik:
		print("\r\033[1;94mCloning\033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print "\n\033[1;97m«--•◄►••◄►•---\x1b[1;94m•◄►•Stop Process Press CTRL+Z•◄►•\033[1;97m---•◄►••◄►•-»"
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mKAMIGROUP\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
	jalan(' \033[1;97m.................\033[1;94mCloning Start..\033[1;97m............ ')
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mKAMIGROUP\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
	...
	p.map(main, id)
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mKAMIGROUP\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;94m«---•◄►•---Developed By GHAZALI-KING--•◄►•---»" #KAMI:GROUP
	print '\033[1;94m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (0 & Data Reset)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;94mCP \033[1;97m: \033[1;97m"+str(len(oks))+"\033[1;97m/\033[1;91m"+str(len(cekpoint))
	print """
...
▀███▀░░▀███▀░░██░██░██░██░░░░██░░░ 
         ...
         Checkpoint ID Open After 7 Days
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;94m .....GHAZALI**KING **KAMI**GROUP....... \033[1;97m :
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;94m +923094161457"""
...
def super():
	...
	print "\033[1;97m-•◄►•-\033[1;97m> \033[1;97m1.\x1b[1;93mClone Friend List Public ID."
        print "\033[1;97m-•◄►•-\033[1;97m> \033[1;97m2.\x1b[1;93mKAMI GROUPFacebook Group India."
        print "\033[1;97m-•◄►•-\033[1;97m> \033[1;97m3.\x1b[1;93mKAMI GROUPYoutube Chenal."
	print "\033[1;97m-•◄►•-\033[1;97m> \033[1;97m0.\033[1;91mBack"
	pilih_super()
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mKamiGroup\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;94m«---•◄►•---Developed By Ghazali-king-•◄►•---»" #Dev:King
